...
int main()
{
	...
	enable_global_int();
	RTOS_CreateTask(toggle_led1, 100, 0,50);//(TaskHandler, Periodicity, periority,FirstDelay)
	RTOS_CreateTask(toggle_led2, 200, 1,100);
	RTOS_CreateTask(toggle_led3, 300, 2,150);
	RTOS_voidStartOS();
	while(1)
	{
